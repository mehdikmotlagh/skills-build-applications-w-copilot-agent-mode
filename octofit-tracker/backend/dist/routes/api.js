...
router.get('/teams/:id', async (req, res) => {
    try {
        ...
        res.status(500).json({ message: 'Unable to fetch team', error: error.message });
    }
});
...
router.get('/workouts/:id', async (req, res) => {
    try {
        ...
        res.status(500).json({ message: 'Unable to fetch workout', error: error.message });
    }
});
